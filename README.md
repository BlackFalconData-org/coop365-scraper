# Coop365 Scraper - Danish Grocery Products & Prices

Extract structured data from [365discount.coop.dk](https://365discount.coop.dk) — current Coop365 leaflet rows from 365discount.coop.dk with structured names, prices, unit quantities, comparison prices, validity windows, catalog context and product links for Danish grocery price tracking.

**[Coop365 Scraper - Danish Grocery Products & Prices on Apify →](https://apify.com/blackfalcondata/coop365-scraper?fpr=1h3gvi)**
...
Integrate with your ETL pipeline to collect structured listings from 365discount.coop.dk on a schedule. Export to CSV, JSON, or directly to your database. Use compact mode to control output size.

**Market research**
Monitor listings, track trends, and analyze market dynamics with structured, deduplicated data from 365discount.coop.dk.
...
| `catalogIds` | array | `[]` | Optional exact catalog IDs. Leave empty to use active Coop365 catalogs automatically. |
...
Every listing returns the same 44-field schema. Missing values are `null` — never omitted.
...
*Truncated — full records contain 44 fields. See Output fields for the complete schema.*

**[Try Coop365 Scraper - Danish Grocery Products & Prices now — $5 free credit, no credit card →](https://apify.com/blackfalcondata/coop365-scraper?fpr=1h3gvi)**
...
See the [actor on Apify](https://apify.com/blackfalcondata/coop365-scraper?fpr=1h3gvi) for current pricing.

---

## FAQ

**How do I scrape 365discount.coop.dk?**
Use this actor on Apify to extract structured data from 365discount.coop.dk. Configure your search query and filters in the input, then click Start — no coding required.

**How do I get 365discount.coop.dk data as JSON, CSV, or Excel?**
...
Web scraping of publicly available data is generally legal. This actor only accesses publicly visible information. Always check 365discount.coop.dk's terms of service for your specific use case.
...
- [Kvickly Scraper](https://apify.com/blackfalcondata/kvickly-scraper?fpr=1h3gvi) — Danish grocery leaflet products and prices from Kvickly
...
2. Open [Coop365 Scraper - Danish Grocery Products & Prices](https://apify.com/blackfalcondata/coop365-scraper?fpr=1h3gvi) and configure your input
3. Click **Start** — export results as JSON, CSV, or Excel
